 ...
 */
 public class CompressPicHelper { 
	...
	// 图片处理 
 	/*public static String compressPic(String inputDir, String outputDir, String inputFileName, String outputFileName, int outputWidth, int outputHeight, boolean proportion) { 
 		try { 
			 //获得源文件 
 	...
 	public static void main(String[] arg) { 
 		CompressPicHelper.compressPic("e:\\test\\", "e:\\test\\", "1.jpg", "r1.jpg", 120, 120, true);
