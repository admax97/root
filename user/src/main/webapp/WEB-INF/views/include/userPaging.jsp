...
<script type="text/javascript">
    ...
    function paging(pageNo){
        ...
        }else if(pageId == 'modalPaging2'){

            goModalPaging2(pageNo,pageSize);

        }else if(pageId == 'modalPaging3'){

            goModalPaging3(pageNo,pageSize);

        }else if(pageId == 'modalPaging4'){

            goModalPaging4(pageNo,pageSize);

        }else if(pageId == 'modalPaging5'){

            goModalPaging5(pageNo,pageSize);

        }else if(pageId == 'modalPaging6'){

            goModalPaging6(pageNo,pageSize);

        }else if(pageId == 'modalPaging99'){ //课程查询窗口分页 共通专用 99 begin...

            goModalPaging99(pageNo,pageSize);

        }else if(pageId == 'modalPaging98'){ //试卷查询窗口分页 共通专用 99 begin...

            goModalPaging98(pageNo,pageSize);

        }else if(pageId == 'modalPaging97'){ //域管理员 and 讲师表查询窗口分页 共通专用 99 begin...

            goModalPaging97(pageNo,pageSize);
