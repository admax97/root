...
<main class="benefits container">
    ...
    <div class="row">
        <form class="form-horizontal" action="${ctx}/test/loginProc" method="post" name="loginForm" id="loginForm">
