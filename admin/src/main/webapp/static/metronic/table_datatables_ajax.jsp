...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #2 | Ajax Datatables</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic Admin Theme #2 for basic datatable samples" name="description" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-container">
           ...
           <!-- <div class="page-sidebar-wrapper">
                ...
                &lt;!&ndash; DOC: Set data-auto-scroll="false" to disable the sidebar from auto scrolling/focusing &ndash;&gt;
                &lt;!&ndash; DOC: Change data-auto-speed="200" to adjust the sub menu slide up/down speed &ndash;&gt;
                <div class="page-sidebar navbar-collapse collapse">
                    &lt;!&ndash; BEGIN SIDEBAR MENU &ndash;&gt;
                    &lt;!&ndash; DOC: Apply "page-sidebar-menu-light" class right after "page-sidebar-menu" to enable light sidebar menu style(without borders) &ndash;&gt;
                    &lt;!&ndash; DOC: Apply "page-sidebar-menu-hover-submenu" class right after "page-sidebar-menu" to enable hoverable(hover vs accordion) sub menu mode &ndash;&gt;
                    &lt;!&ndash; DOC: Apply "page-sidebar-menu-closed" class right after "page-sidebar-menu" to collapse("page-sidebar-closed" class must be applied to the body element) the sidebar sub menu mode &ndash;&gt;
                    &lt;!&ndash; DOC: Set data-auto-scroll="false" to disable the sidebar from auto scrolling/focusing &ndash;&gt;
                    &lt;!&ndash; DOC: Set data-keep-expand="true" to keep the submenues expanded &ndash;&gt;
                    &lt;!&ndash; DOC: Set data-auto-speed="200" to adjust the sub menu slide up/down speed &ndash;&gt;
