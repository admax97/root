...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #2 | Material Design Form Validation</title>
...
<![endif]-->
            ...
            <script src="${ctx}/static/assets/pages/scripts/form-validation-md.min.js" type="text/javascript"></script>
